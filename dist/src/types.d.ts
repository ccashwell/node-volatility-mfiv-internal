...
export declare type MethodologyEvidence<V extends Version, E extends Evidence, M extends Metadata, C extends Context, P extends Params, R extends Result> = {
    version: V;
    type: E;
    metadata?: M;
    context: C;
...
export declare type MfivOptionSummary = OptionSummary & OptionPrice & {
    midPrice?: number;
    markPrice: number;
    source: "mid" | "mark";
...
export declare type MfivResult = MfivEstimate & MfivResultWithInverse & {
...
export declare type MfivEvidence = MethodologyEvidence<"2022-01-01", "mfiv.estimate.evidence", unknown, MfivContext, MfivParams, MfivResult>;
export { MfivContext, MfivParams };
